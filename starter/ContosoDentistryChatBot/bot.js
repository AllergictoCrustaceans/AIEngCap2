...
class DentaBot extends ActivityHandler {
    constructor(configuration, qnaOptions) {
        ...
        this.onMessage(async (context, next) => {
            ...
            // don't forget 'await'
            const intentResults = await this.IntentRecognizer.executeLuisQuery(context);
            console.log('What is the luis result: ', intentResults);
        ...
        this.onMembersAdded(async (context, next) => {
            ...
            const welcomeText = 'Heyo! Welcome to Contoso Dental Clinic. Please ask us any questions, or schedule an appointment with us :D';
